...
text_output = Path("../text_outputs/deepseek/deepseek_v3_temp_0")
text_output_path = text_output / "deepseek_v3_temp_0_model_results.txt"
...
results_dir = Path("../results/deepseek/deepseek_v3_temp_0")
timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')

if df is not None and not df.empty:
    try:
        excel_output_path = results_dir / f"deepseek_v3_temp_0_model_results_{timestamp}.xlsx"
