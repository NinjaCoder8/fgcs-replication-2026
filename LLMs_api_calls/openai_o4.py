...
text_output = Path("../text_outputs/openai/o4")
text_output_path = text_output / "openai_o4_model_results.txt"
...
results_dir = Path("../results/openai/o4")
timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')

if df is not None and not df.empty:
    try:
        excel_output_path = results_dir / f"openai_o4_results_{timestamp}.xlsx"
