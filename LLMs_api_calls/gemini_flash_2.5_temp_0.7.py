...
text_output = Path("../text_outputs/gemini/gemini_flash_2.5_temp_0.7")
text_output.mkdir(parents=True, exist_ok=True)
text_output_path = text_output / "gemini_flash_2.5_temp_0.7_model_results.txt"
...
results_dir = Path("../results/gemini/gemini_flash_2.5_temp_0.7")
timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')

if df is not None and not df.empty:
    try:
        excel_output_path = results_dir / f"gemini_flash_2.5_temp_0.7_model_results_{timestamp}.xlsx"
